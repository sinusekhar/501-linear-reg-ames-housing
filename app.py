...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                ...
                dcc.Input(id='OverallCond', value=5, type='number', min=1, max=10, step=1),
    ...
    html.Div('Predicted Price = (- $1,360.5K Baseline) + ($0.7K * Year Built) + ($12.7K * Bathrooms) + (- $7.7K * Bedrooms) + ($0.049K * Total Square Feet) + ($ 25.2K * Single Family Home) + ( $9.2 K * Overall Condition)'),
    html.Br(),
...
def ames_lr_function(clicks, YearBuilt,Bathrooms,BedroomAbvGr,TotalSF,SingleFam,OverallCond):
    if clicks==0:
